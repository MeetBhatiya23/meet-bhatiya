...
export const skills = [
    {
        ...
        skills: [
            ...
            {
                name: "Tailwind CSS",
                image: "https://images.seeklogo.com/logo-png/35/2/tailwind-css-logo-png_seeklogo-354675.png",
            },
        ],
    },
    // {
    ...
    // },
    {
        ...
        skills: [
            ...
            {
                name: "Express Js",
                image: "https://p7.hiclipart.com/preview/405/905/302/virtual-tour-photography-3d-floor-plan-virtual-reality-panorama-exercito.jpg",
            },
            // {
            //   name: "Graph Ql",
...
export const experiences = [
    {
        id: 0,
        img: "/images/comapny.png",
        role: "Frontend Engineer Intern",
        company: "DDS",
        date: "Jan 2024 - Jul 2024",
        desc: "As a Frontend Engineer Intern, I worked closely with the design and development teams to build responsive, user-friendly interfaces using HTML, CSS, JavaScript, React.js, and Tailwind CSS. I contributed to real-world projects where performance, accessibility, and design precision were critical.",
        skills: [
            "ReactJS",
            "Redux",
            "NodeJs",
    ...
    // },
    {
        ...
        desc: "Currently working as a Full Stack Developer at DDS Company, I specialize in building dynamic, scalable, and high-performance web applications using the MERN stack (MongoDB, Express.js, React.js, and Node.js). My role involves developing both client-side and server-side logic, integrating RESTful APIs, and maintaining clean, efficient code for optimal performance.",
        skills: [
            "ReactJS",
            "Redux",
            "NodeJs",
    ...
    // },
    {
        ...
        desc: "As a passionate developer, I actively contribute to open source projects to collaborate with the global developer community and continuously enhance my coding skills. I’ve contributed to various GitHub repositories by fixing bugs, improving documentation, and building features, especially in the JavaScript and React ecosystems.",
    },
];
...
export const education = [
    {
        id: 0,
        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeZ5sZumtKG86KeZD9KpRXfzd7tiHYW8DFKQ&s",
        school: "S.V. Patel College, Gujarat",
        date: "june-2021 – march-2024",
        grade: "8.41 CGPA",
        desc: "During my BCA journey at S.V. Patel College, I gained a strong foundation in computer science, programming, and modern software development. The curriculum equipped me with practical skills in areas such as web development, data structures, database management, object-oriented programming, and software engineering.I actively participated in academic projects, coding workshops, and tech events, which enhanced both my technical abilities and problem-solving mindset. My time at the college not only sharpened my technical skills but also helped me grow as a team player and communicator—essential traits for success in the tech industry.",
        degree: "Bachelor of Computer Applications (BCA)",
    },
    {
        id: 1,
        img: "/images/mauni.png",
        school: "Mauni International School",
        date: "2021",
        grade: "92.2%",
        desc: "I pursued my 12th-grade studies at Mauni International School, specializing in the Science stream. This phase of my education deepened my understanding of Physics, Chemistry, and Mathematics, and played a key role in preparing me for my undergraduate journey in computer applications.Both of these institutions helped me grow academically and personally, fostering curiosity, self-discipline, and a strong drive to pursue excellence in the field of technology.",
        degree: "Higher Secondary Certificate (12th Grade – Commerce Stream)",
    },
    {
        id: 2,
        img: "/images/rbdhami.png",
        school: "R.B. Dhami High School",
        date: "2019",
        grade: "75.3%",
        desc: "I completed my 10th-grade education at R.B. Dhami High School, where I built a strong academic foundation and developed a disciplined approach to learning. During this time, I focused on core subjects like Mathematics, Science, and English, which helped shape my logical thinking and interest in technology.",
...
export const projects = [
    {
        ...
        image: "/website-images/ninja.png",
        tags: [
            "HTML",
            "CSS"
        ],
    ...
    },
    {
        ...
        image: "/website-images/dreamHub.png",
        tags: [
            "Docker",
            "AWS",
            "DuckDNS",
        ...
        category: "web app",
        github: "",
        webapp: "https://xipson.netlify.app/",
    },
    {
        id: 0,
        title: "Podstream",
